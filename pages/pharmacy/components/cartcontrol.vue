	...
	<view style="display: flex;flex-direction: row;height: 27px;">
		<view class="food-control">
			<view class="cont" style="margin-top: 2px;" @click="decreaseCart(food)" v-show="food.count>0">
				<image src="https://se2021-pic-bed.oss-cn-shanghai.aliyuncs.com/phermacy/des.png" mode="" style="width: 20px;height: 20px;"></image>
			</view>
		...
		<view style="flex: 1;margin-top: 2px; " class="cont" @click="addCart(food)">
			<image src="https://se2021-pic-bed.oss-cn-shanghai.aliyuncs.com/phermacy/add.png" style="width: 20px;height: 20px;color: #CCCCCC;" mode=""></image>
		</view>
	</view>
</template>
